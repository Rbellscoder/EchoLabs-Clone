...
// UsageContainer import removed: not available in this workspace
...
export function DashboardSidebar() {
  ...
  const othersMenuItems: MenuItem[] = [
    ...
    },
    {
      ...
      url: "mailto:belloryan82@gmail.com",
      icon: Headphones,
    },
  ];
  ...
  return (
    ...
    <Sidebar collapsible="icon">
      ...
      <SidebarFooter className="gap-3 py-3">
        {/* Placeholder for usage info (originally UsageContainer) */}
        <Skeleton className="h-8.5 w-full rounded-md border border-border bg-white" />
        <SidebarMenu>
          <SidebarMenuItem>
            <UserButton
              showName
